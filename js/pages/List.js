    ...
    data() {
        return {
            ...
            list: [
                ...
                { name: "Jawbreaker", author: "ZenthicAlpha", verifier: "🇨🇿 Earl12", points: 200, type: "main", minimum: 62, verification: "https://www.youtube.com/watch?v=lyzBbyVT4-Y", originalPlacement: 2, records: [{ user: "🇲🇾 Cylio", percent: 91, link: "#" },{ user: "🇻🇳 trumandigma", percent: 65, link: "#" }] },
                ...
                { name: "Skeletal Shenanigans", author: "YoReid", verifier: "🇻🇳 trumandigma", points: 195, type: "main", minimum: 64, verification: "https://www.youtube.com/watch?v=kO205r4sZKM", originalPlacement: 2, records: [] },
                { name: "Sirius", author: "FunnyGame", verifier: "🇻🇳 trumandigma", points: 190, type: "main", minimum: 73, verification: "https://www.youtube.com/watch?v=6AxuV3e_6E4", originalPlacement: 4, records: [] },
                { name: "B", author: "MotleyOrc", verifier: "🇻🇳 trumandigma", points: 190, type: "main", minimum: 61, verification: "https://www.youtube.com/watch?v=sjmc5HaGrYc", originalPlacement: 1, records: [{ user: "🇲🇾 Cylio", percent: 64, link: "#" }] },
                { name: "ZXCircleS", author: "Wintter", verifier: "🇲🇾 Cylio", points: 0, type: "main", minimum: 63, verification: "https://www.youtube.com/watch?v=J4bgGT9euJw", originalPlacement: 6, records: [ { user: "🇨🇿 Earl12", percent: 86, link: "#" } ] },
                { name: "Verity Circles", author: "🇨🇿 Earl12", verifier: "🇨🇿 Earl12", points: 145, type: "main", minimum: 68, verification: "https://www.youtube.com/watch?v=6YfglJsJYfI", originalPlacement: 9, records: [ { user: "🇻🇳 trumandigma", percent: 86, link: "#" }] },
                { name: "Deadlocked", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 72, verification: "https://www.youtube.com/watch?v=reZj2Xbt05Q", originalPlacement: 2, records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" },{ user: "🇲🇾 Cylio", percent: 77, link: "#" } ] },
                { name: "Anima", author: "BridgetTheCroco", verifier: "🇻🇳 trumandigma", points: 170, type: "main", minimum: 67, verification: "#", originalPlacement: 16, records: [{ user: "🇨🇿 Earl12", percent: 100, link: "" }] },
                { name: "Hellishment", author: "🇨🇿 Earl12", verifier: "🇨🇿 Earl12", points: 145, type: "main", minimum: 81, verification: "https://www.youtube.com/watch?v=8RJstOZvoUQ", originalPlacement: 6, records: [{ user: "🇻🇳 trumandigma", percent: 100, link: "#" },{ user: "🇲🇾 Cylio", percent: 100, link: "https://www.youtube.com/watch?v=pbiPSgZKpd8" }] },
                { name: "Problematic", author: "Dharfin", verifier: "🇲🇾 Cylio", points: 0, type: "main", minimum: 64, verification: "#", originalPlacement: 9, records: [{ user: "🇻🇳 trumandigma", percent: 100, link: "#" }] },
                { name: "Theory of Everything 2", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 175, type: "main", minimum: 72, verification: "https://www.youtube.com/watch?v=medoq_Znhaw", originalPlacement: 3, records: [{ user: "🇨🇿 Earl12", percent: 100, link: "#" }] },
                { name: "Retro Circles", author: "Nacho boii", verifier: "🇻🇳 trumandigma", points: 175, type: "main", minimum: 70, verification: "https://www.youtube.com/watch?v=yVxKTQPzyus", originalPlacement: 16, records: [] },
                { name: "Blackfire Backfire", author: "kira9999", verifier: "🇻🇳 trumandigma", points: 170, type: "main", minimum: 69, verification: "https://www.youtube.com/watch?v=2h1FgtfaP1k", originalPlacement: 5, records: [] },
                { name: "Darkstep", author: "Alex", verifier: "🇻🇳 trumandigma", points: 165, type: "main", minimum: 70, verification: "https://www.youtube.com/watch?v=6cFZYLraEJs", originalPlacement: 6, records: [] },
                { name: "Speed Racer", author: "Zenthicalpha", verifier: "🇻🇳 trumandigma", points: 150, type: "main", minimum: 71, verification: "https://www.youtube.com/watch?v=R8RsJVKKd8w", originalPlacement: 7, records: [{ user: "🇨🇿 Earl12", percent: 73, link: "#" },{ user: "🇲🇾 Cylio", percent: 100, link: "#" }] },
                { name: "Unnerfed noument", author: "🇨🇿 Earl12", verifier: "🇻🇳 trumandigma", points: 160, type: "main", minimum: 75, verification: "#", originalPlacement: 8, records: [{ user: "🇨🇿 Earl12", percent: 100, link: "" }] },
                { name: "Clutterfunk V2", author: "Neptune", verifier: "🇨🇿 Earl12", points: 130, type: "main", verification: "https://www.youtube.com/watch?v=Kkrp9G-vYeE", originalPlacement: 11, records: [ { user: "🇻🇳 trumandigma", percent: 100, link: "https://www.youtube.com/watch?v=2kE93FgLRcs" } ] },
                { name: "Lights Speed", author: "Experience dihhh", verifier: "🇻🇳 trumandigma", points: 150, type: "main", minimum: 79, verification: "https://www.youtube.com/watch?v=ypvgbkVtlSM", originalPlacement: 17, records: [{ user: "🇨🇿 Earl12", percent: 100, link: "#" }] }, 
                { name: "Clubstep", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 155, type: "main", minimum: 78, verification: "https://www.youtube.com/watch?v=gok5ShDXxg4", originalPlacement: 5, records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" } ] },
                { name: "IceStream", author: "DarnocBlue", verifier: "🇨🇿 Earl12", points: 160, type: "main", minimum: 74, verification: "https://www.youtube.com/watch?v=2pSl4YVCILc", originalPlacement: 14, records: [] },
                { name: "Noument", author: "🇨🇿 Earl12", verifier: "🇨🇿 Earl12", points: 145, type: "main", minimum: 75, verification: "https://www.youtube.com/watch?v=W_rqtk3cipE", originalPlacement: 11, records: [ { user: "🇻🇳 trumandigma", percent: 100, link: "#" },{ user: "🇲🇾 Cylio", percent: 100, link: "https://www.youtube.com/watch?v=PA_5LXPnBMc" }] },
                { name: "Electro Rand", author: "GmwadBoy", verifier: "🇨🇿 Earl12", points: 140, type: "main", minimum: 81, verification: "https://www.youtube.com/watch?v=MZYw7jL9BnQ", originalPlacement: 20, records: [] },
                { name: "Space Club", author: "D0meR", verifier: "🇨🇿 Earl12", points: 140, type: "main", minimum: 81, verification: "#", originalPlacement: 22, records: [] },
                { name: "Maymory", author: "ItsKiba", verifier: "🇨🇿 Earl12", points: 140, type: "main", minimum: 80, verification: "https://www.youtube.com/watch?v=EKP5rGdOf_o", originalPlacement: 11, records: [ { user: "🇻🇳 trumandigma", percent: 100, link: "#" } ] },
                { name: "Theory of Every V2", author: "Neptune", verifier: "🇨🇿 Earl12", points: 135, type: "main", minimum: 70, verification: "https://www.youtube.com/watch?v=d39W_TzuGLs", originalPlacement: 9, records: [] },
                { name: "Electroman Adventures V2", author: "Neptune", verifier: "🇻🇳 trumandigma", points: 125, type: "main", minimum: 68, verification: "https://www.youtube.com/watch?v=-LJ3Q-pWZdo", originalPlacement: 14, records: [] },
                { name: "Electrodynamix", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 120, type: "main", minimum: 78, verification: "https://www.youtube.com/watch?v=fGjDZgluC60", originalPlacement: 13, records: [{ user: "🇲🇾 Cylio", percent: 100, link: "#" },{ user: "🇨🇿 Earl12", percent: 85, link: "#" }] },
                { name: "iSpyWithMyLittleEye", author: "Voxicat", verifier: "🇻🇳 trumandigma", points: 115, type: "main", minimum: 67, verification: "https://www.youtube.com/watch?v=Ow7nDnZTbDw", originalPlacement: 7, records: [] },
                { name: "Crescendo", author: "MasK463", verifier: "🇨🇿 Earl12", points: 110, type: "main", minimum: 80, verification: "https://www.youtube.com/watch?v=ndx5WJv-P3E", originalPlacement: 15, records: [ { user: "🇻🇳 trumandigma", percent: 100, link: "#" } ] },
                { name: "m tolot", author: "🇨🇿 Earl12", verifier: "🇨🇿 Earl12", points: 105, type: "main", minimum: 81, verification: "#", originalPlacement: 17, records: [] },
                { name: "Insane Club", author: "5Duck", verifier: "🇨🇿 Earl12", points: 105, type: "main", minimum: 79, verification: "#", originalPlacement: 18, records: [] },
                { name: "Microphone", author: "Masterthecube5", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 81, minimum: 0, verification: "", originalPlacement: 27, records: [] },
                { name: "xStep V2", author: "Neptune", verifier: "🇨🇿 Earl12", points: 0, type: "main", minimum: 82, verification: "https://www.youtube.com/watch?v=K9rBb0HVvMg", originalPlacement: 18, records: [ { user: "🇻🇳 trumandigma", percent: 100, link: "#" } ] },
                { name: "Shiver", author: "SpKale", verifier: "🇨🇿 Earl12", points: 0, type: "main", verification: "", minimum: 76, originalPlacement: 23, records: [{ user: "🇻🇳 trumandigma", percent: 100, link: "#" }] },
                { name: "Justice for Julinka", author: "🇨🇿 Earl12", verifier: "🇨🇿 Earl12", points: 0, type: "main", minimum: 73, verification: "https://www.youtube.com/watch?v=Ppe3l-HoBLs", originalPlacement: 30, records: [] },
                { name: "Phjork", author: "Cerufiffy", verifier: "🇻🇳 trumandigma", points: 0, type: "main", minimum: 81, verification: "", originalPlacement: 24, records: [{ user: "🇨🇿 Earl12", percent: 100, link: "#" },{ user: "🇲🇾 Cylio", percent: 100, link: "#" } ] },
                { name: "Demon Forest", author: "Ketis", verifier: "🇻🇳 trumandigma", points: 0, type: "main", minimum: 81, verification: "", originalPlacement: 22, records: [{ user: "🇨🇿 Earl12", percent: 100, link: "#" }] },
                { name: "Demon Mixed", author: "RealOggy", verifier: "🇨🇿 Earl12", points: 0, type: "main", minimum: 80, verification: "", originalPlacement: 23, records: [] },
                { name: "Hexagon Force", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 0, type: "main", minimum: 72, verification: "", originalPlacement: 25, records: [{ user: "🇲🇾 Cylio", percent: 100, link: "#" }] },
                { name: "Platinum Adventure", author: "Jerry4", verifier: "🇨🇿 Earl12", points: 0, type: "main", minimum: 81, verification: "", originalPlacement: 24, records: [{ user: "🇻🇳 trumandigma", percent: 100, link: "#" },{ user: "🇨🇿 Krystof", percent: 100, link: "#" }] },
                { name: "Blast Processing V2", author: "Neptune", verifier: "🇨🇿 Earl12", points: 0, type: "main",minimum: 100, verification: "", originalPlacement: 38, records: [] },
                { name: "yStep", author: "TherealDarnoc", verifier: "🇨🇿 Earl12", points: 180, type: "main", minimum: 80, verification: "https://www.youtube.com/watch?v=xO2j6OMTiLo", originalPlacement: 39, records: [] },
                { name: "Noobaman Adventures", author: "noobas", verifier: "🇨🇿 Earl12", points: 180, type: "main", minimum: 80, verification: "https://www.youtube.com/watch?v=2OkvfRSOYy08VZ1f", originalPlacement: 40, records: [] },
                { name: "ice cave", author: "Ketis", verifier: "🇨🇿 Earl12", points: 180, type: "main", minimum: 89, verification: "", originalPlacement: 36, records: [] },
                ...
                { name: "The Nightmare", author: "Jax", verifier: "🇨🇿 Earl12", points: 0, type: "main", minimum: 81, verification: "", originalPlacement: 27, records: [{ user: "🇻🇳 trumandigma", percent: 100, link: "#" },{ user: "🇲🇾 Cylio", percent: 100, link: "#" }] },
                { name: "The Lightning Road", author: "Timeless Real", verifier: "🇨🇿 Earl12", points: 0, type: "extended", minimum: 100, verification: "", originalPlacement: 22, records: [{ user: "🇻🇳 trumandigma", percent: 100, link: "#" },{ user: "🇨🇿 Thomas", percent: 100, link: "#" },{ user: "🇲🇾 Cylio", percent: 100, link: "#" }] },
                { name: "Clutterfunk", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, type: "extended", minimum: 100, verification: "", originalPlacement: 45, records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" },{ user: "🇲🇾 Cylio", percent: 100, link: "#" } ] },             
                { name: "SakupEase Circles", author: "Thndrrgod", verifier: "🇨🇿 Earl12", points: 0, type: "extended", minimum: 100, verification: "https://www.youtube.com/watch?v=hX2Ct2P9VqQ", originalPlacement: 52, records: [] },
                ...
                { name: "Jawbreasy", author: "matix", verifier: "🇨🇿 Earl12", points: 0, type: "extended", minimum: 100, verification: "https://www.youtube.com/watch?v=QJ2MSv32SJc", originalPlacement: 54, records: [] },
                ...
                { name: "Bloodbath but No", author: "Texic", verifier: "🇨🇿 Earl12", points: 0, type: "extended", minimum: 100, verification: "", originalPlacement: 51, records: [] },
                { name: "Electroman Adventures", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, minimum: 100, type: "extended", minimum: 100, verification: "", originalPlacement: 49, records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" },{ user: "🇨🇿 Thomas", percent: 100, link: "#" },{ user: "🇲🇾 Cylio", percent: 100, link: "#" },{ user: "🇨🇿 zubnikartacka", percent: 83, link: "#" } ] },
                { name: "Flappy Bird", author: "TherealDarnoc", verifier: "🇨🇿 Earl12", points: 180, type: "extended", minimum: 100, verification: "", originalPlacement: 53, records: [] },
