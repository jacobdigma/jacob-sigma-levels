...
export default {
    ...
    data() {
        return {
            ...
            list: [
                // --- MAIN LIST ---
                { rank: 1, name: "Verity", author: "Serponge", verifier: "trumandigma", points: 200, type: "main", verification: "https://www.youtube.com/watch?v=p15w9mb2eac", records: [] },
                { rank: 2, name: "Skeletal Shenanigans", author: "YoReid", verifier: "trumandigma", points: 195, type: "main", verification: "https://www.youtube.com/watch?v=mgzTHUKatQo", records: [] },
                { rank: 3, name: "B", author: "MotleyOrc", verifier: "trumandigma", points: 190, type: "main", verification: "https://www.youtube.com/watch?v=F2Y0SOVWoC4", records: [] },
                { rank: 4, name: "Deadlocked", author: "RobTop", verifier: "trumandigma", points: 180, type: "main", verification: "https://www.youtube.com/watch?v=Uly1hr3KJPA", records: [ { user: "Earl12", percent: 79, link: "https://www.youtube.com/watch?v=8Iryy_McSo" } ] },
                { rank: 5, name: "Theory of Everything 2", author: "RobTop", verifier: "trumandigma", points: 175, type: "main", verification: "https://www.youtube.com/watch?v=IYI4ouUIV80", records: [] },
                { rank: 6, name: "Blackfire Backfire", author: "kira9999", verifier: "trumandigma", points: 170, type: "main", verification: "https://www.youtube.com/watch?v=2h1fGtfap1k", records: [] },
                { rank: 7, name: "Darkstep", author: "Alex", verifier: "trumandigma", points: 165, type: "main", verification: "https://www.youtube.com/watch?v=M7n8FchVXLA", records: [] },
                { rank: 8, name: "Unnerfed noument", author: "Stetkos", verifier: "trumandigma", points: 160, type: "main", verification: "#", records: [] },
                { rank: 9, name: "Clubstep", author: "RobTop", verifier: "trumandigma", points: 155, type: "main", verification: "https://www.youtube.com/watch?v=Gok55hDxxg4", records: [ { user: "Earl12", percent: 100, link: "#" } ] },
                { rank: 10, name: "Speed Racer", author: "Zenthicalpha", verifier: "trumandigma", points: 150, type: "main", verification: "https://www.youtube.com/watch?v=R8RsJVKKd8w", records: [] },
                { rank: 11, name: "Noument", author: "Earl12", verifier: "Earl12", points: 145, type: "main", verification: "https://www.youtube.com/watch?v=w_rqtk3c1pE", records: [] },

                // --- EXTENDED LIST ---
                { rank: 12, name: "Electro Rand", author: "GmwadBoy", verifier: "Earl12", points: 140, type: "extended", verification: "https://www.youtube.com/watch?v=H2Ya7jL9BnQ", records: [] },
                { rank: 13, name: "Maymory", author: "ItsKiba", verifier: "Earl12", points: 140, type: "extended", verification: "https://www.youtube.com/watch?v=VIGXceGyJ_M", records: [ { user: "trumandigma", percent: 100, link: "#" } ] },
                { rank: 14, name: "Theory of Every V2", author: "Neptune", verifier: "Earl12", points: 135, type: "extended", verification: "https://www.youtube.com/watch?v=EHHIdR7DX1E", records: [] },
                { rank: 15, name: "Clutterfunk V2", author: "Neptune", verifier: "Earl12", points: 130, type: "extended", verification: "https://www.youtube.com/watch?v=Kkrp9G-vYEE", records: [ { user: "trumandigma", percent: 100, link: "2KE9S_FgCRs" } ] },
                { rank: 16, name: "Electroman Adventures V2", author: "Neptune", verifier: "trumandigma", points: 125, type: "extended", verification: "https://www.youtube.com/watch?v=s4OFSZs-bec", records: [] },
                { rank: 17, name: "Electrodynamix", author: "RobTop", verifier: "trumandigma", points: 120, type: "extended", verification: "https://www.youtube.com/watch?v=bXh5zDZb-Y", records: [] },
                { rank: 18, name: "iSpyWithMyLittleEye", author: "Voxicat", verifier: "trumandigma", points: 115, type: "extended", verification: "https://www.youtube.com/watch?v=Qw7NDnZTDw", records: [] },
                { rank: 19, name: "Crescendo", author: "MasK463", verifier: "Earl12", points: 110, type: "extended", verification: "https://www.youtube.com/watch?v=1SAOuFTR49Y", records: [ { user: "trumandigma", percent: 100, link: "#" } ] },
