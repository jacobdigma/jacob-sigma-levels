...
export default {
    ...
    <div style="flex: 1; padding: 25px; box-sizing: border-box;">
        <div v-if="entry" style="display: flex; flex-direction: column; align-items: center; width: 100%;">
            
            <!-- Teprve TADY omezíme šířku samotné karty na 440px -->
            <div class="player-profile-card" style="width: 100%; max-width: 440px; background: #ffffff; border: 1px solid #e1e4e8; border-radius: 8px; padding: 25px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); text-align: center; box-sizing: border-box; margin-bottom: 30px;">
            ...
            <!-- Seznam dokončených démonů se vykreslí až TADY, takže bude mít plnou šířku a skočí pod kartu -->
