    ...
    data() {
        return {
            ...
            list: [
                ...
                { name: "Noument", author: "🇨🇿 Earl12", verifier: "🇨🇿 Earl12", points: 145, type: "main", minimum: 75, verification: "https://www.youtube.com/watch?v=W_rqtk3cipE", records: [ { user: "🇻🇳 trumandigma", percent: 100, link: "#" } ] },
                { name: "Electro Rand", author: "GmwadBoy", verifier: "🇨🇿 Earl12", points: 140, type: "main", verification: "https://www.youtube.com/watch?v=MZYw7jL9BnQ", records: [] },
                ...
                { name: "Maymory", author: "ItsKiba", verifier: "🇨🇿 Earl12", points: 140, type: "main", verification: "https://www.youtube.com/watch?v=EKP5rGdOf_o", records: [ { user: "🇻🇳 trumandigma", percent: 100, link: "#" } ] },
                { name: "Theory of Every V2", author: "Neptune", verifier: "🇨🇿 Earl12", points: 135, type: "main", verification: "https://www.youtube.com/watch?v=d39W_TzuGLs", records: [] },
                { name: "Electroman Adventures V2", author: "Neptune", verifier: "🇻🇳 trumandigma", points: 125, type: "main", verification: "https://www.youtube.com/watch?v=-LJ3Q-pWZdo", records: [] },
                { name: "Electrodynamix", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 120, type: "main", verification: "https://www.youtube.com/watch?v=fGjDZgluC60", records: [] },
                { name: "iSpyWithMyLittleEye", author: "Voxicat", verifier: "🇻🇳 trumandigma", points: 115, type: "main", verification: "https://www.youtube.com/watch?v=Ow7nDnZTbDw", records: [] },
                { name: "Crescendo", author: "MasK463", verifier: "🇨🇿 Earl12", points: 110, type: "main", verification: "https://www.youtube.com/watch?v=ndx5WJv-P3E", records: [ { user: "🇻🇳 trumandigma", percent: 100, link: "#" } ] },
                { name: "m tolot", author: "🇨🇿 Earl12", verifier: "🇨🇿 Earl12", points: 105, type: "main", verification: "#", records: [] },
                { name: "Insane Club", author: "5Duck", verifier: "🇨🇿 Earl12", points: 105, type: "main", verification: "#", records: [] },
                { name: "Microphone", author: "Masterthecube5", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 0, verification: "", records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" } ] },
                { name: "xStep V2", author: "Neptune", verifier: "🇨🇿 Earl12", points: 0, type: "main", verification: "https://www.youtube.com/watch?v=K9rBb0HVvMg", records: [ { user: "🇻🇳 trumandigma", percent: 100, link: "#" } ] },
                { name: "Shiver", author: "SpKale", verifier: "🇨🇿 Earl12", points: 0, type: "main", verification: "", records: [{ user: "🇻🇳 trumandigma", percent: 100, link: "#" }] },
                { name: "Phjork", author: "Cerufiffy", verifier: "🇻🇳 trumandigma", points: 0, type: "main", verification: "", records: [{ user: "🇨🇿 Earl12", percent: 100, link: "#" }] },
                ...
                { name: "Noobaman Adventures", author: "noobas", verifier: "🇨🇿 Earl12", points: 180, type: "main", minimum: 80, verification: "https://youtu.be/xO2j6OMTiLo?si=2OkvfRSOYy08VZ1f", records: [] },
                ...
                { name: "Clutterfunk", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 80, verification: "", records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" } ] },
                { name: "Theory of Everything", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 80, verification: "", records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" } ] },
                { name: "Dash", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 80, verification: "", records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" },{ user: "🇨🇿 Thomas", percent: 100, link: "#" } ] },
                { name: "Fingerdash", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 80, verification: "", records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" } ] },
                { name: "Xstep", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 80, verification: "", records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" },{ user: "🇨🇿 Thomas", percent: 100, link: "#" },{ user: "🇨🇿 zubnikartacka", percent: 100, link: "#" }] },
                { name: "Bloodbath but No", author: "Texic", verifier: "🇨🇿 Earl12", points: 0, type: "main", verification: "", records: [] },
                { name: "Electroman Adventures", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 73, verification: "", records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" },{ user: "🇨🇿 Thomas", percent: 100, link: "#" },{ user: "🇨🇿 zubnikartacka", percent: 83, link: "#" } ] },
                { name: "Flappy Bird", author: "TherealDarnoc", verifier: "🇨🇿 Earl12", points: 180, type: "main", minimum: 80, verification: "", records: [] },
                { name: "Geometrical Dominator", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 80, verification: "", records: [ { user: "🇨🇿 Krystof", percent: 100, link: "#" } ] },
                { name: "Time Machine", author: "RobTop", verifier: "🇻🇳 trumandigma", points: 180, type: "main", minimum: 80, verification: "", records: [ { user: "🇨🇿 Earl12", percent: 100, link: "#" } ] }
                // --- EXTENDED LIST ---
                // --- LEGACY LIST ---
                ]
        };
